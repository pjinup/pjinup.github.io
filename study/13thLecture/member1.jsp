...
<!DOCTYPEhtml>	<!--	member1.html	-->
<html>
<head>
<meta charset="utf-8"/>
<meta name="viewport"content="width=device-width,initial-scale=1"/>

<link rel="stylesheet"href="https://pjinup.github.io/study/13thLecture/sample.css"/>
...
<% String sName = request.getParameter("sName"); out.println("<input id='id12' class='class3' type='text' name='sName' size='20' maxlength='50' value='" + sName +"'/>");%></div>
